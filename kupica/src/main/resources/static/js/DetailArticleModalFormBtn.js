...
const detailArticleModalSection = document.getElementById("detail_article_modal_section");
...
function dismissDetailArticleModal() {
    ...
    document.getElementById('detail__article__modal__content__comment__input__nickname').value = '';
    document.getElementById('detail__article__modal__content__comment__input__password').value = '';
    document.getElementById('detail__article__modal__content__comment__input').value = '';
...
const detailArticleModifyModalSection = document.getElementById("detail_article_modify_modal_section");
...
const detailArticleDeleteModalSection = document.getElementById("detail_article_delete_modal_section");
...
const commentModifyModalSection = document.getElementById("comment_modify_modal_section");
...
const commentDeleteModalSection = document.getElementById("comment_delete_modal_section");
